...
public class AboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public AboutUs() {
            ...
            super("About Us - Galgotias University");
            ...
            JLabel l6 = new JLabel("Developed By : NAMAN RAJ SHARMA");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Addmission Number - 18SCSE1010066");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("E-mail : namanrajsharma2611@gmail.com");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l8.setBounds(70, 290, 600, 34);
            contentPane.add(l8);

            JLabel l9 = new JLabel("Course - B.Tech CSE");
            l9.setFont(new Font("Trebuchet MS", Font.BOLD , 20));
            l9.setBounds(70, 320, 600, 34);
            contentPane.add(l9);


            JLabel l10 = new JLabel("Contact - +91 7289022470");
